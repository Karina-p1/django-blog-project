...
from .models import Category, Post, Comment, Profile # Importing the Post and Comment models from the current app's models.py file to register them with the admin site
...
admin.site.register(Category) # Registering the Category model with the admin site to make it manageable through the Django admin interface